...
export default class DashBoard extends Component<any, any> {
  ...
  private titleScreen (): React.ReactNode {
    return (
      <Form name="screen_form" layout="inline">
        <Form.Item label="姓名">
          <Input placeholder="请输入" value={this.state.name} style={{ width: 160 }} onChange={this.changeName}/>
        </Form.Item>
        <Form.Item label="工作：">
          <Select defaultValue="" style={{ width: 160 }} placeholder="请选择" onChange={this.changeStatus}>
            <Option value="1">上班</Option>
            <Option value="2">在家</Option>
            <Option value="3">做饭</Option>
          </Select>
        </Form.Item>
        <Form.Item>
